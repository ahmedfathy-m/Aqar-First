...
public class Endpoint<R>: ResponseRequestable {
    ...
    public var queryListParameters: [(String, Any)]
    ...
    init(path: String,
         ...
         queryListParameters: [(String, Any)] = [],
         bodyParamatersEncodable: Encodable? = nil,
         bodyParamaters: [String: Any] = [:],files:[Attachment]? = nil,
...
public protocol Requestable {
    ...
    var queryListParameters: [(String, Any)] { get }
    var bodyParamatersEncodable: Encodable? { get }
    var bodyParamaters: [String: Any] { get }
    var bodyEncoding: BodyEncoding { get }
    var files:[Attachment]?{ get }
...
extension Requestable {
    ...
    func url(with config: NetworkConfigurable) throws -> URL {
        ...
        queryListParameters.forEach {
            urlQueryItems.append(URLQueryItem(name: $0.0, value: "\($0.1)"))
              }
    ...
    public func urlRequest(with config: NetworkConfigurable) throws -> URLRequest {
        ...
        if self.isAuthenticate {
            allHeaders["Authorization"] = "Bearer \(try AuthManager.shared.keychain.string(forKey: "accessToken") )"
        }
        allHeaders["language"] = L10n.shared.language
        allHeaders["app-version"] = "1.0.3"
        allHeaders["Accept-Language"] = L10n.shared.language
        ...
        urlRequest.setValue(L10n.shared.language, forHTTPHeaderField: "language")
        return urlRequest
    }
